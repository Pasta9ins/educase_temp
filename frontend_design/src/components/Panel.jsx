        ...
        <div className="min-h-screen bg-gray-50 flex justify-center rubik">
            <div className="w-full max-w-md  rounded-md shadow-sm">
                ...
                <div className="mt-4 text-md text-gray-700 leading-relaxed px-5">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Omnis perspiciatis rerum neque eum id autem natus pariatur quaerat doloribus, suscipit eius. Voluptatum veritatis pariatur quia atque officiis deleniti, corrupti vero?
                </div>
